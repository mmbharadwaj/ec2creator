...
#AWS variables
vpc_id="vpc-3691475d"
sub_id="subnet-3e728e55"
#route_table="rtb-12345"
#internet_gateway="igw-12345"
sec_id="sg-02efb968dd8747010"
aws_image_id="086be6d514a32d0f4"
i_type="t2.micro"
tag="ec2"
aws_key_name="senario1"
ssh_key="senario1.pem"
uid=$RANDOM

# Generate AWS Keys and store in this local box
echo -e "\e[32m Generating key Pairs\033[0m"
aws ec2 create-key-pair --key-name senario1 --query 'KeyMaterial' --output text 2>&1 | tee $ssh_key
